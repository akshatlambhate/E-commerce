    ...
    <>
      ...
      >
        {SaleData.map((dev,i)=>(
          ...
          <button className='bg-white	 hover:text-white hover:bg-AirBlue	 text-AirBlue font-bold py-2 px-8 rounded lg:w-[30%] xs:w-[70%]'>Shop Collection <FontAwesomeIcon icon={faArrowRight} /></button>
          </div>
          </SwiperSlide>
        ))}
