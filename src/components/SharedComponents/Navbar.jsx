...
const Navbar = () => {
  return (
    <div className="lg:flex lg:py-6 lg:justify-between xs:flex xs:justify-between xs:h-50vh opacity-100 text-white border-b-gray-600 border-b-2 xs:p-2" id="nav">
      <div className="flex xs:relative " id="navleft ">
      <div className="lg:w-40 absolute lg:-mt-14 xs:w-20 xs:-mt-7" id="logo">
        <Link to={"/"}><img src={logo2} alt="logo"  className=""/></Link>
        <p className=""></p>
      </div>
      <div className="lg:flex xs:hidden my-4 mr-4 ml-32 " id="left-menu">
      ...
      <div id="navright" className="lg:flex  mx-2 my-4 mr-6 xs:hidden">
      ...
      <div className="px-2 text-2xl text-buttoncolor  mx-2 cursor-pointer hover:text-buttoncolorhover "><Link to={"/cartpage"}><FontAwesomeIcon icon={faCartShopping}/></Link></div>
      <div className="px-2 text-2xl  text-buttoncolor mx-2 cursor-pointer hover:text-buttoncolorhover"><Link to={"/signuppage"}><FontAwesomeIcon icon={faUserTie}/></Link></div>
      
      </div>
      <div className="sm:contents lg:hidden px-2 text-2xl  text-buttoncolor mx-4 cursor-pointer hover:text-buttoncolorhover"><FontAwesomeIcon icon={faBars}/></div> 
    </div>
  );
};
