...
const Navbar = () => {
  return (
    <div className="lg:flex lg:py-6 lg:justify-between xs:flex xs:justify-between xs:h-50vh opacity-100 text-white border-b-gray-600 border-b-2" id="nav">
      ...
      <div className="lg:flex xs:hidden my-4 mr-8 ml-36 " id="left-menu">
        <ul className="lg:flex list-none mx-2 ">
      ...
      <div id="navright" className="lg:flex  mx-3 my-4 mr-12 xs:hidden">
