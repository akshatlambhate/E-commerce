...
const AboutUs = () => {
  return (
    <div className='p-8 bg-background shadow-xl  '>
      ...
      sm:w-[100%] sm:flex sm:flex-col   shadow-lg '>
        ...
        xs:w-full text-left border-t-4 border-buttoncolor'>
      ...
      xs:p-6 xs:flex xs:items-center' >
        <p className='p-8 lg:text-base md:text-sm xs:text-xs text-darkBlue border-2 border-buttoncolor'>We guarantee the highest quality of the products we sell. Several decades of successful operation and millions of happy customers let us feel certain about that. Besides, all items we sell pass thorough quality control, so no characteristics mismatch can escape the eye of our professionals.</p>
      </div>
    </div>
  )
}
