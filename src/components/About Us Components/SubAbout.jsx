...
const SubAbout = () => {
  return (
      ...
      xs:grid xs:grid-cols-1 xs:mt-2 xs:mb-2 xs:text-left shadow-lg bg-childdiv'>
        {dataAbout.map((data)=>(
        <>
        ...
        border-t-4 border-buttoncolor'>
          <h1 className='lg:text-base text-colortxt font-semibold
          xs:text-sm text-poppins'>{data.heading}</h1>
